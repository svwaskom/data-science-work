...
# SW: I have no idea what this means!!
# from the solution, it seems like piping is just like...take this object & sequentially do stuff to it. so...
diamonds %>% # diamonds will be grouped by cut before being summarized
  group_by(cut) %>% # so group them by cut
  summarize( # now diamonds are still being piped, so summarize that piped object PLUS the mean_price
